...
_Generated 2026-05-12 13:27:25 — 30 checkpoint(s), 199 features._

## Diagnostics — model health overview

### ⚠ `trust_instability` · **warn** — 149/199 features are unstable across checkpoints

**What was observed.** More than half (75%) of features changed archetype between checkpoints (similarity-weighted stability < 0.5).
...
**What was observed.** Noise 12%, Catalyst 25%, Complex 31%.
...
**What was observed.** k=4 functional groups, silhouette=0.35, permutation p=0.000, bootstrap ARI=0.42, best group NC fraction=36%.  Abort triggered because: no group has >50% Noise Candidates (best=36%) ; bootstrap stability low (ARI=0.42<0.5).
...
**What was observed.** Final-checkpoint mean Volatility = 3.966e-06 ; median of earlier checkpoints = 4.566e-06 (ratio = 0.87×).
...
### ℹ `trust_keep_recommended` · **info** — 40 features are stably important across all checkpoints
...
|-----|------|-----|-----|-----|
| impact | 0.0101 | 0.0220 | 0.0003 | 0.1630 |
| volatility | 0.0000 | 0.0000 | 0.0000 | 0.0001 |
| nonlinearity | 0.0031 | 0.0039 | 0.0001 | 0.0332 |
| interaction | 0.1356 | 0.1240 | 0.0233 | 0.7200 |
...
|--|--|--|--|--|
| 1 | gwl | 0.1630 | 0.7001 | Catalyst |
| 2 | gwl_t-1 | 0.1399 | 0.6032 | Catalyst |
| 3 | rain | 0.1145 | 0.7200 | Catalyst |
| 4 | gwl_t-2 | 0.1070 | 0.4659 | Catalyst |
| 5 | gwl_t-3 | 0.0873 | 0.3801 | Catalyst |
| 6 | gwl_t-4 | 0.0710 | 0.3286 | Catalyst |
| 7 | rain_t-2 | 0.0621 | 0.3399 | Catalyst |
| 8 | rain_t-1 | 0.0606 | 0.4703 | Catalyst |
| 9 | gwl_t-5 | 0.0554 | 0.3199 | Catalyst |
| 10 | rain_t-3 | 0.0540 | 0.3523 | Catalyst |
...
|--|--|--|--|
| Noise | 24 | 12.1% | low everywhere — candidate for pruning |
| Hidden Interactor | 1 | 0.5% | weak alone, strong via interactions |
| Workhorse | 1 | 0.5% | strong, linear, independent |
| Catalyst | 49 | 24.6% | strong AND interacting — load-bearing |
| Nonlinear Driver | 13 | 6.5% | strong with curved relationship |
| Volatile Specialist | 12 | 6.0% | strong but context-dependent |
| Stable Contributor | 38 | 19.1% | moderate, reliable |
| Complex Driver | 61 | 30.7% | complex behaviour across all four axes |
...
|--|--|--|
| INVESTIGATE (unstable) | 149 | archetype flipped — role uncertain |
| CONFIDENTLY KEEP | 39 | stable + important — load-bearing |
| MONITOR (borderline) | 10 | stability between 0.5 and 0.7 |
| KEEP (stable) | 1 | stable but moderate importance |

**Investigate** (149): `gwl_t-24`, `gwl_t-23`, `gwl_t-22`, `gwl_t-21`, `gwl_t-20`, `gwl_t-19`, `gwl_t-18`, `gwl_t-17`, `gwl_t-16`, `gwl_t-15`
...
- **k** = 4 groups
- **silhouette** = 0.346  _(higher = tighter clusters; >0.5 is strong, >0.2 is moderate)_
- **permutation p-value** = 0.000  _(<0.05 means clusters aren't random)_
- **bootstrap ARI** = 0.416  _(≥0.5 means clustering is stable)_
- **best NC fraction** = 36.4%  _(needs >50% to prune)_

| Group | Size | NC % | Mean Impact | Recommendation |
|--|--|--|--|--|
| 0 | 117 | 4.3% | 0.0127 | KEEP — mostly useful |
| 1 | 37 | 21.6% | 0.0096 | KEEP — mostly useful |
| 2 | 22 | 36.4% | 0.0052 | REVIEW — significant noise |
| 3 | 23 | 13.0% | 0.0024 | KEEP — mostly useful |
