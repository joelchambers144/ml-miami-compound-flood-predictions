...
_Generated 2026-05-12 13:27:31 — 30 checkpoint(s), 187 features._

## Diagnostics — model health overview

### ⚠ `trust_instability` · **warn** — 113/187 features are unstable across checkpoints

**What was observed.** More than half (60%) of features changed archetype between checkpoints (similarity-weighted stability < 0.5).
...
**What was observed.** Noise 16%, Catalyst 25%, Complex 32%.
...
**What was observed.** k=6 functional groups, silhouette=0.42, permutation p=0.000, bootstrap ARI=0.34, best group NC fraction=39%.  Abort triggered because: no group has >50% Noise Candidates (best=39%) ; bootstrap stability low (ARI=0.34<0.5).
...
**What was observed.** Final-checkpoint mean Volatility = 1.779e-05 ; median of earlier checkpoints = 1.419e-05 (ratio = 1.25×).
...
### ℹ `trust_keep_recommended` · **info** — 48 features are stably important across all checkpoints
...
|-----|------|-----|-----|-----|
| impact | 0.0149 | 0.0358 | 0.0001 | 0.3080 |
| volatility | 0.0000 | 0.0001 | 0.0000 | 0.0003 |
| nonlinearity | 0.0066 | 0.0253 | 0.0002 | 0.2890 |
| interaction | 0.1609 | 0.2713 | 0.0125 | 1.9783 |
...
|--|--|--|--|--|
| 1 | gwl | 0.3080 | 1.9783 | Catalyst |
| 2 | gwl_t-1 | 0.2256 | 1.5382 | Catalyst |
| 3 | gwl_t-2 | 0.1629 | 1.1128 | Catalyst |
| 4 | rain_t+10 | 0.1035 | 0.7900 | Catalyst |
| 5 | gwl_t-3 | 0.1034 | 0.7022 | Catalyst |
| 6 | rain_t+9 | 0.1016 | 0.8063 | Catalyst |
| 7 | rain_t+8 | 0.0943 | 0.7267 | Catalyst |
| 8 | rain_t+1 | 0.0813 | 0.5819 | Catalyst |
| 9 | rain_t+5 | 0.0807 | 0.9774 | Catalyst |
| 10 | rain_t+6 | 0.0778 | 0.8011 | Catalyst |
...
|--|--|--|--|
| Noise | 29 | 15.5% | low everywhere — candidate for pruning |
| Hidden Interactor | 1 | 0.5% | weak alone, strong via interactions |
| Catalyst | 46 | 24.6% | strong AND interacting — load-bearing |
| Nonlinear Driver | 10 | 5.3% | strong with curved relationship |
| Volatile Specialist | 10 | 5.3% | strong but context-dependent |
| Stable Contributor | 31 | 16.6% | moderate, reliable |
...
|--|--|--|
| INVESTIGATE (unstable) | 113 | archetype flipped — role uncertain |
| CONFIDENTLY KEEP | 43 | stable + important — load-bearing |
| MONITOR (borderline) | 26 | stability between 0.5 and 0.7 |
| KEEP (stable) | 5 | stable but moderate importance |

**Investigate** (113): `gwl_t-24`, `gwl_t-22`, `gwl_t-21`, `gwl_t-20`, `gwl_t-17`, `gwl_t-16`, `gwl_t-15`, `gwl_t-14`, `gwl_t-13`, `gwl_t-12`
...
- **k** = 6 groups
- **silhouette** = 0.422  _(higher = tighter clusters; >0.5 is strong, >0.2 is moderate)_
- **permutation p-value** = 0.000  _(<0.05 means clusters aren't random)_
- **bootstrap ARI** = 0.345  _(≥0.5 means clustering is stable)_
- **best NC fraction** = 38.9%  _(needs >50% to prune)_

| Group | Size | NC % | Mean Impact | Recommendation |
|--|--|--|--|--|
| 0 | 55 | 18.2% | 0.0357 | KEEP — mostly useful |
| 1 | 3 | 33.3% | 0.012 | REVIEW — significant noise |
| 2 | 18 | 38.9% | 0.0044 | REVIEW — significant noise |
| 3 | 19 | 31.6% | 0.0036 | REVIEW — significant noise |
| 4 | 87 | 4.6% | 0.0073 | KEEP — mostly useful |
| 5 | 5 | 20.0% | 0.0007 | KEEP — mostly useful |
