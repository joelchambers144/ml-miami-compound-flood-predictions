...
_Generated 2026-05-12 13:27:27 — 30 checkpoint(s), 178 features._

## Diagnostics — model health overview

### ⚠ `trust_instability` · **warn** — 114/178 features are unstable across checkpoints
...
**What was observed.** Noise 13%, Catalyst 23%, Complex 31%.
...
**What was observed.** k=2 functional groups, silhouette=0.33, permutation p=0.000, bootstrap ARI=0.04, best group NC fraction=29%.  Abort triggered because: no group has >50% Noise Candidates (best=29%) ; bootstrap stability low (ARI=0.04<0.5).
...
**What was observed.** Final-checkpoint mean Volatility = 3.609e-06 ; median of earlier checkpoints = 3.976e-06 (ratio = 0.91×).
...
### ℹ `trust_keep_recommended` · **info** — 35 features are stably important across all checkpoints
...
|-----|------|-----|-----|-----|
| impact | 0.0124 | 0.0319 | 0.0001 | 0.2804 |
| volatility | 0.0000 | 0.0000 | 0.0000 | 0.0002 |
| nonlinearity | 0.0044 | 0.0095 | 0.0004 | 0.0896 |
| interaction | 0.1108 | 0.1167 | 0.0208 | 0.8107 |
...
|--|--|--|--|--|
| 1 | gwl | 0.2804 | 0.8107 | Catalyst |
| 2 | gwl_t-1 | 0.2012 | 0.6334 | Catalyst |
| 3 | gwl_t-2 | 0.1515 | 0.4727 | Catalyst |
| 4 | gwl_t-3 | 0.1122 | 0.3899 | Catalyst |
| 5 | rain_t+1 | 0.0856 | 0.5194 | Catalyst |
| 6 | gwl_t-4 | 0.0837 | 0.2772 | Catalyst |
| 7 | rain_t+2 | 0.0740 | 0.4756 | Catalyst |
| 8 | stgH | 0.0626 | 0.2256 | Catalyst |
| 9 | gwl_t-5 | 0.0601 | 0.2014 | Catalyst |
| 10 | gwl_t-6 | 0.0545 | 0.2007 | Catalyst |
...
|--|--|--|--|
| Noise | 23 | 12.9% | low everywhere — candidate for pruning |
| Hidden Interactor | 4 | 2.2% | weak alone, strong via interactions |
| Catalyst | 41 | 23.0% | strong AND interacting — load-bearing |
| Nonlinear Driver | 12 | 6.7% | strong with curved relationship |
| Volatile Specialist | 6 | 3.4% | strong but context-dependent |
| Stable Contributor | 36 | 20.2% | moderate, reliable |
| Complex Driver | 56 | 31.5% | complex behaviour across all four axes |
...
|--|--|--|
| INVESTIGATE (unstable) | 114 | archetype flipped — role uncertain |
...
**Investigate** (114): `gwl_t-24`, `gwl_t-22`, `gwl_t-21`, `gwl_t-19`, `gwl_t-18`, `gwl_t-17`, `gwl_t-12`, `gwl_t-10`, `wl_t-24`, `wl_t-23`
...
- **k** = 2 groups
- **silhouette** = 0.328  _(higher = tighter clusters; >0.5 is strong, >0.2 is moderate)_
- **permutation p-value** = 0.000  _(<0.05 means clusters aren't random)_
- **bootstrap ARI** = 0.036  _(≥0.5 means clustering is stable)_
- **best NC fraction** = 28.6%  _(needs >50% to prune)_

| Group | Size | NC % | Mean Impact | Recommendation |
|--|--|--|--|--|
| 0 | 143 | 9.1% | 0.0145 | KEEP — mostly useful |
| 1 | 35 | 28.6% | 0.0039 | KEEP — mostly useful |
