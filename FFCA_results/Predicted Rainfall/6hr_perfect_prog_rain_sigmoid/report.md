...
_Generated 2026-05-12 13:27:29 — 30 checkpoint(s), 181 features._

## Diagnostics — model health overview

### ⚠ `trust_instability` · **warn** — 115/181 features are unstable across checkpoints
...
**What was observed.** k=3 functional groups, silhouette=0.26, permutation p=0.000, bootstrap ARI=0.27, best group NC fraction=21%.  Abort triggered because: no group has >50% Noise Candidates (best=21%) ; bootstrap stability low (ARI=0.27<0.5).
...
**What was observed.** Final-checkpoint mean Volatility = 3.737e-06 ; median of earlier checkpoints = 4.123e-06 (ratio = 0.91×).
...
|-----|------|-----|-----|-----|
| impact | 0.0124 | 0.0280 | 0.0003 | 0.2151 |
| volatility | 0.0000 | 0.0000 | 0.0000 | 0.0002 |
| nonlinearity | 0.0066 | 0.0129 | 0.0004 | 0.0964 |
| interaction | 0.1698 | 0.2004 | 0.0333 | 1.1731 |
...
|--|--|--|--|--|
| 1 | gwl | 0.2151 | 1.1731 | Catalyst |
| 2 | gwl_t-1 | 0.1688 | 1.0547 | Catalyst |
| 3 | gwl_t-2 | 0.1331 | 0.7878 | Catalyst |
| 4 | gwl_t-3 | 0.1086 | 0.7071 | Catalyst |
| 5 | gwl_t-4 | 0.0927 | 0.6124 | Catalyst |
| 6 | rain_t+4 | 0.0857 | 0.5221 | Catalyst |
| 7 | gwl_t-5 | 0.0802 | 0.4599 | Catalyst |
| 8 | rain_t+3 | 0.0718 | 0.6524 | Catalyst |
| 9 | rain_t+2 | 0.0705 | 0.6599 | Catalyst |
| 10 | rain_t+5 | 0.0695 | 0.6250 | Catalyst |
...
| Catalyst | 43 | 23.8% | strong AND interacting — load-bearing |
| Nonlinear Driver | 11 | 6.1% | strong with curved relationship |
| Volatile Specialist | 11 | 6.1% | strong but context-dependent |
| Stable Contributor | 35 | 19.3% | moderate, reliable |
| Complex Driver | 58 | 32.0% | complex behaviour across all four axes |
...
| CONFIDENTLY KEEP | 36 | stable + important — load-bearing |
| MONITOR (borderline) | 28 | stability between 0.5 and 0.7 |
| KEEP (stable) | 2 | stable but moderate importance |

**Investigate** (115): `gwl_t-24`, `gwl_t-23`, `gwl_t-21`, `gwl_t-18`, `gwl_t-16`, `gwl_t-15`, `gwl_t-14`, `gwl_t-13`, `gwl_t-12`, `gwl_t-11`
...
- **k** = 3 groups
- **silhouette** = 0.259  _(higher = tighter clusters; >0.5 is strong, >0.2 is moderate)_
- **permutation p-value** = 0.000  _(<0.05 means clusters aren't random)_
- **bootstrap ARI** = 0.273  _(≥0.5 means clustering is stable)_
- **best NC fraction** = 21.4%  _(needs >50% to prune)_

| Group | Size | NC % | Mean Impact | Recommendation |
|--|--|--|--|--|
| 0 | 90 | 7.8% | 0.0184 | KEEP — mostly useful |
| 1 | 42 | 21.4% | 0.0041 | KEEP — mostly useful |
| 2 | 49 | 8.2% | 0.0086 | KEEP — mostly useful |
