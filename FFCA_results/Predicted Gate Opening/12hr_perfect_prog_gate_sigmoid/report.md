...
_Generated 2026-05-12 13:27:38 — 30 checkpoint(s), 199 features._

## Diagnostics — model health overview

### ⚠ `trust_instability` · **warn** — 127/199 features are unstable across checkpoints

**What was observed.** More than half (64%) of features changed archetype between checkpoints (similarity-weighted stability < 0.5).
...
**What was observed.** Noise 9%, Catalyst 24%, Complex 35%.
...
**What was observed.** k=2 functional groups, silhouette=0.25, permutation p=0.000, bootstrap ARI=0.38, best group NC fraction=10%.  Abort triggered because: no group has >50% Noise Candidates (best=10%) ; bootstrap stability low (ARI=0.38<0.5).
...
**What was observed.** Final-checkpoint mean Volatility = 9.497e-06 ; median of earlier checkpoints = 6.753e-06 (ratio = 1.41×).
...
### ℹ `trust_keep_recommended` · **info** — 47 features are stably important across all checkpoints
...
|-----|------|-----|-----|-----|
| impact | 0.0095 | 0.0209 | 0.0005 | 0.1536 |
| volatility | 0.0000 | 0.0000 | 0.0000 | 0.0003 |
| nonlinearity | 0.0050 | 0.0091 | 0.0003 | 0.0927 |
| interaction | 0.1413 | 0.1599 | 0.0339 | 1.1811 |
...
|--|--|--|--|--|
| 1 | gwl | 0.1536 | 1.1811 | Catalyst |
| 2 | gwl_t-1 | 0.1299 | 0.9862 | Catalyst |
| 3 | gwl_t-2 | 0.1052 | 0.8145 | Catalyst |
| 4 | rain | 0.0956 | 0.8761 | Catalyst |
| 5 | gwl_t-3 | 0.0882 | 0.7203 | Catalyst |
| 6 | rain_t-1 | 0.0737 | 0.7408 | Catalyst |
| 7 | gwl_t-4 | 0.0693 | 0.5136 | Catalyst |
| 8 | gwl_t-5 | 0.0585 | 0.4295 | Catalyst |
| 9 | rain_t-3 | 0.0566 | 0.4370 | Catalyst |
| 10 | rain_t-2 | 0.0540 | 0.5319 | Catalyst |
...
|--|--|--|--|
| Noise | 18 | 9.0% | low everywhere — candidate for pruning |
| Hidden Interactor | 2 | 1.0% | weak alone, strong via interactions |
| Catalyst | 48 | 24.1% | strong AND interacting — load-bearing |
| Nonlinear Driver | 12 | 6.0% | strong with curved relationship |
| Volatile Specialist | 14 | 7.0% | strong but context-dependent |
| Stable Contributor | 36 | 18.1% | moderate, reliable |
| Complex Driver | 69 | 34.7% | complex behaviour across all four axes |
...
| CONFIDENTLY KEEP | 44 | stable + important — load-bearing |
| MONITOR (borderline) | 25 | stability between 0.5 and 0.7 |
| KEEP (stable) | 3 | stable but moderate importance |

**Investigate** (127): `gwl_t-24`, `gwl_t-21`, `gwl_t-20`, `gwl_t-18`, `gwl_t-17`, `gwl_t-16`, `gwl_t-15`, `wl_t-23`, `wl_t-22`, `wl_t-21`
...
- **k** = 2 groups
- **silhouette** = 0.254  _(higher = tighter clusters; >0.5 is strong, >0.2 is moderate)_
- **permutation p-value** = 0.000  _(<0.05 means clusters aren't random)_
- **bootstrap ARI** = 0.385  _(≥0.5 means clustering is stable)_
- **best NC fraction** = 9.7%  _(needs >50% to prune)_

| Group | Size | NC % | Mean Impact | Recommendation |
|--|--|--|--|--|
| 0 | 75 | 8.0% | 0.0201 | KEEP — mostly useful |
| 1 | 124 | 9.7% | 0.0031 | KEEP — mostly useful |
