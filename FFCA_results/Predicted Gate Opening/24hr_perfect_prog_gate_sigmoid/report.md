...
_Generated 2026-05-12 13:27:40 — 30 checkpoint(s), 223 features._

## Diagnostics — model health overview

### ⚠ `trust_instability` · **warn** — 161/223 features are unstable across checkpoints
...
**What was observed.** Noise 9%, Catalyst 24%, Complex 34%.
...
**What was observed.** k=6 functional groups, silhouette=0.18, permutation p=0.000, bootstrap ARI=0.21, best group NC fraction=14%.  Abort triggered because: no group has >50% Noise Candidates (best=14%) ; bootstrap stability low (ARI=0.21<0.5).
...
**What was observed.** Final-checkpoint mean Volatility = 6.396e-06 ; median of earlier checkpoints = 8.709e-06 (ratio = 0.73×).
...
|-----|------|-----|-----|-----|
| impact | 0.0067 | 0.0130 | 0.0004 | 0.0845 |
| volatility | 0.0000 | 0.0000 | 0.0000 | 0.0001 |
| nonlinearity | 0.0043 | 0.0078 | 0.0005 | 0.0735 |
| interaction | 0.1428 | 0.1562 | 0.0350 | 1.0037 |
...
|--|--|--|--|--|
| 1 | gwl | 0.0845 | 1.0037 | Catalyst |
| 2 | gwl_t-1 | 0.0754 | 0.8843 | Catalyst |
| 3 | gwl_t-2 | 0.0660 | 0.7828 | Catalyst |
| 4 | rain | 0.0655 | 0.7856 | Catalyst |
| 5 | gwl_t-3 | 0.0557 | 0.6704 | Catalyst |
| 6 | rain_t-1 | 0.0520 | 0.6047 | Catalyst |
| 7 | gwl_t-4 | 0.0486 | 0.6076 | Catalyst |
| 8 | rain_t-2 | 0.0452 | 0.5863 | Catalyst |
| 9 | rain_t-4 | 0.0407 | 0.4770 | Catalyst |
| 10 | rain_t-3 | 0.0398 | 0.5396 | Catalyst |
...
|--|--|--|--|
| Noise | 20 | 9.0% | low everywhere — candidate for pruning |
| Hidden Interactor | 2 | 0.9% | weak alone, strong via interactions |
| Workhorse | 1 | 0.4% | strong, linear, independent |
| Catalyst | 54 | 24.2% | strong AND interacting — load-bearing |
| Nonlinear Driver | 15 | 6.7% | strong with curved relationship |
| Volatile Specialist | 19 | 8.5% | strong but context-dependent |
| Stable Contributor | 37 | 16.6% | moderate, reliable |
| Complex Driver | 75 | 33.6% | complex behaviour across all four axes |
...
|--|--|--|
| INVESTIGATE (unstable) | 161 | archetype flipped — role uncertain |
| CONFIDENTLY KEEP | 46 | stable + important — load-bearing |
| MONITOR (borderline) | 14 | stability between 0.5 and 0.7 |
| KEEP (stable) | 2 | stable but moderate importance |

**Investigate** (161): `gwl_t-24`, `gwl_t-23`, `gwl_t-22`, `gwl_t-21`, `gwl_t-20`, `gwl_t-19`, `gwl_t-18`, `gwl_t-17`, `gwl_t-16`, `gwl_t-15`
...
- **k** = 6 groups
- **silhouette** = 0.182  _(higher = tighter clusters; >0.5 is strong, >0.2 is moderate)_
- **permutation p-value** = 0.000  _(<0.05 means clusters aren't random)_
- **bootstrap ARI** = 0.208  _(≥0.5 means clustering is stable)_
- **best NC fraction** = 13.9%  _(needs >50% to prune)_

| Group | Size | NC % | Mean Impact | Recommendation |
|--|--|--|--|--|
| 0 | 59 | 3.4% | 0.0174 | KEEP — mostly useful |
| 1 | 72 | 13.9% | 0.0034 | KEEP — mostly useful |
| 2 | 34 | 11.8% | 0.0031 | KEEP — mostly useful |
| 3 | 20 | 5.0% | 0.0021 | KEEP — mostly useful |
| 4 | 29 | 6.9% | 0.0023 | KEEP — mostly useful |
| 5 | 9 | 11.1% | 0.0021 | KEEP — mostly useful |
