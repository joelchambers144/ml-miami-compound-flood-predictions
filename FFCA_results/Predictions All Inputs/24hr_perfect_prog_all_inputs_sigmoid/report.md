...
_Generated 2026-05-12 13:27:47 — 30 checkpoint(s), 271 features._

## Diagnostics — model health overview

### ⚠ `trust_instability` · **warn** — 176/271 features are unstable across checkpoints

**What was observed.** More than half (65%) of features changed archetype between checkpoints (similarity-weighted stability < 0.5).
...
**What was observed.** Noise 13%, Catalyst 25%, Complex 32%.
...
**What was observed.** k=4 functional groups, silhouette=0.20, permutation p=0.000, bootstrap ARI=0.24, best group NC fraction=20%.  Abort triggered because: no group has >50% Noise Candidates (best=20%) ; bootstrap stability low (ARI=0.24<0.5).
...
**What was observed.** Final-checkpoint mean Volatility = 1.295e-05 ; median of earlier checkpoints = 7.505e-06 (ratio = 1.73×).
...
### ℹ `trust_keep_recommended` · **info** — 69 features are stably important across all checkpoints
...
|-----|------|-----|-----|-----|
| impact | 0.0155 | 0.0307 | 0.0005 | 0.1493 |
| volatility | 0.0000 | 0.0000 | 0.0000 | 0.0001 |
| nonlinearity | 0.0072 | 0.0121 | 0.0004 | 0.0647 |
| interaction | 0.3739 | 0.5520 | 0.0545 | 2.4490 |
...
|--|--|--|--|--|
| 1 | gwl | 0.1493 | 1.9454 | Catalyst |
| 2 | gwl_t-1 | 0.1247 | 1.6172 | Catalyst |
| 3 | rain_t+16 | 0.1185 | 1.9219 | Catalyst |
| 4 | rain_t+18 | 0.1178 | 2.4490 | Catalyst |
| 5 | rain_t+20 | 0.1176 | 2.4152 | Catalyst |
| 6 | rain_t+7 | 0.1079 | 2.1820 | Catalyst |
| 7 | rain_t+17 | 0.1077 | 2.1317 | Catalyst |
| 8 | rain_t+14 | 0.1068 | 1.7526 | Catalyst |
| 9 | rain_t+8 | 0.1062 | 2.1012 | Catalyst |
| 10 | rain_t+15 | 0.1058 | 1.6629 | Catalyst |
...
|--|--|--|--|
| Noise | 36 | 13.3% | low everywhere — candidate for pruning |
| Hidden Interactor | 1 | 0.4% | weak alone, strong via interactions |
| Catalyst | 67 | 24.7% | strong AND interacting — load-bearing |
| Nonlinear Driver | 16 | 5.9% | strong with curved relationship |
| Volatile Specialist | 15 | 5.5% | strong but context-dependent |
| Stable Contributor | 48 | 17.7% | moderate, reliable |
| Complex Driver | 88 | 32.5% | complex behaviour across all four axes |
...
|--|--|--|
| INVESTIGATE (unstable) | 176 | archetype flipped — role uncertain |
| CONFIDENTLY KEEP | 67 | stable + important — load-bearing |
| MONITOR (borderline) | 26 | stability between 0.5 and 0.7 |
| KEEP (stable) | 2 | stable but moderate importance |

**Investigate** (176): `gwl_t-24`, `gwl_t-23`, `gwl_t-22`, `gwl_t-21`, `gwl_t-20`, `gwl_t-19`, `gwl_t-18`, `gwl_t-17`, `gwl_t-16`, `gwl_t-15`
...
- **k** = 4 groups
- **silhouette** = 0.200  _(higher = tighter clusters; >0.5 is strong, >0.2 is moderate)_
- **permutation p-value** = 0.000  _(<0.05 means clusters aren't random)_
- **bootstrap ARI** = 0.245  _(≥0.5 means clustering is stable)_
- **best NC fraction** = 20.3%  _(needs >50% to prune)_

| Group | Size | NC % | Mean Impact | Recommendation |
|--|--|--|--|--|
| 0 | 70 | 5.7% | 0.0392 | KEEP — mostly useful |
| 1 | 33 | 15.2% | 0.0072 | KEEP — mostly useful |
| 2 | 99 | 13.1% | 0.0077 | KEEP — mostly useful |
| 3 | 69 | 20.3% | 0.0066 | KEEP — mostly useful |
