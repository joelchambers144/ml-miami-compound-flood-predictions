...
_Generated 2026-05-12 13:27:43 — 30 checkpoint(s), 199 features._

## Diagnostics — model health overview

### ⚠ `trust_instability` · **warn** — 122/199 features are unstable across checkpoints
...
**What was observed.** Noise 16%, Catalyst 22%, Complex 28%.
...
**What was observed.** k=2 functional groups, silhouette=0.27, permutation p=0.000, bootstrap ARI=0.25, best group NC fraction=21%.  Abort triggered because: no group has >50% Noise Candidates (best=21%) ; bootstrap stability low (ARI=0.25<0.5).
...
**What was observed.** Final-checkpoint mean Volatility = 2.487e-06 ; median of earlier checkpoints = 3.144e-06 (ratio = 0.79×).
...
|-----|------|-----|-----|-----|
| impact | 0.0146 | 0.0357 | 0.0002 | 0.2787 |
| volatility | 0.0000 | 0.0000 | 0.0000 | 0.0001 |
| nonlinearity | 0.0058 | 0.0119 | 0.0002 | 0.0808 |
| interaction | 0.1639 | 0.2369 | 0.0144 | 1.7032 |
...
|--|--|--|--|--|
| 1 | gwl | 0.2787 | 1.7032 | Catalyst |
| 2 | gwl_t-1 | 0.2004 | 1.1894 | Catalyst |
| 3 | gwl_t-2 | 0.1548 | 0.8849 | Catalyst |
| 4 | rain_t+2 | 0.1381 | 1.0297 | Catalyst |
| 5 | rain_t+1 | 0.1277 | 0.7589 | Catalyst |
| 6 | rain | 0.1188 | 0.5608 | Catalyst |
| 7 | rain_t+3 | 0.1185 | 0.8733 | Catalyst |
| 8 | gwl_t-3 | 0.1170 | 0.6659 | Catalyst |
| 9 | rain_t+4 | 0.1142 | 1.2101 | Catalyst |
| 10 | rain_t+5 | 0.0956 | 1.1690 | Catalyst |
...
|--|--|--|--|
| Noise | 32 | 16.1% | low everywhere — candidate for pruning |
| Hidden Interactor | 7 | 3.5% | weak alone, strong via interactions |
| Catalyst | 43 | 21.6% | strong AND interacting — load-bearing |
| Nonlinear Driver | 15 | 7.5% | strong with curved relationship |
| Volatile Specialist | 4 | 2.0% | strong but context-dependent |
| Stable Contributor | 43 | 21.6% | moderate, reliable |
| Complex Driver | 55 | 27.6% | complex behaviour across all four axes |
...
|--|--|--|
| INVESTIGATE (unstable) | 122 | archetype flipped — role uncertain |
| MONITOR (borderline) | 38 | stability between 0.5 and 0.7 |
| CONFIDENTLY KEEP | 38 | stable + important — load-bearing |
| KEEP (stable) | 1 | stable but moderate importance |

**Investigate** (122): `gwl_t-23`, `gwl_t-21`, `gwl_t-17`, `gwl_t-15`, `gwl_t-14`, `gwl_t-13`, `gwl_t-12`, `gwl_t-11`, `gwl_t-10`, `wl_t-24`
...
- **k** = 2 groups
- **silhouette** = 0.266  _(higher = tighter clusters; >0.5 is strong, >0.2 is moderate)_
- **permutation p-value** = 0.000  _(<0.05 means clusters aren't random)_
- **bootstrap ARI** = 0.254  _(≥0.5 means clustering is stable)_
- **best NC fraction** = 20.8%  _(needs >50% to prune)_

| Group | Size | NC % | Mean Impact | Recommendation |
|--|--|--|--|--|
| 0 | 98 | 11.2% | 0.0205 | KEEP — mostly useful |
| 1 | 101 | 20.8% | 0.0088 | KEEP — mostly useful |
