...
_Generated 2026-05-12 13:27:45 — 30 checkpoint(s), 223 features._

## Diagnostics — model health overview

### ⚠ `trust_instability` · **warn** — 127/223 features are unstable across checkpoints
...
**What was observed.** Noise 10%, Catalyst 25%, Complex 36%.
...
**What was observed.** k=5 functional groups, silhouette=0.24, permutation p=0.000, bootstrap ARI=0.30, best group NC fraction=20%.  Abort triggered because: no group has >50% Noise Candidates (best=20%) ; bootstrap stability low (ARI=0.30<0.5).
...
**What was observed.** Final-checkpoint mean Volatility = 1.068e-05 ; median of earlier checkpoints = 9.065e-06 (ratio = 1.18×).
...
### ℹ `trust_keep_recommended` · **info** — 58 features are stably important across all checkpoints
...
|-----|------|-----|-----|-----|
| impact | 0.0132 | 0.0274 | 0.0003 | 0.1571 |
| volatility | 0.0000 | 0.0000 | 0.0000 | 0.0002 |
| nonlinearity | 0.0135 | 0.0288 | 0.0007 | 0.1825 |
| interaction | 0.3375 | 0.5050 | 0.0507 | 2.8507 |
...
|--|--|--|--|--|
| 1 | gwl | 0.1571 | 2.8507 | Catalyst |
| 2 | gwl_t-1 | 0.1282 | 2.1575 | Catalyst |
| 3 | rain_t+7 | 0.1068 | 2.3055 | Catalyst |
| 4 | rain_t+4 | 0.1067 | 2.1485 | Catalyst |
| 5 | gwl_t-2 | 0.1065 | 1.9337 | Catalyst |
| 6 | rain_t+2 | 0.1017 | 2.0286 | Catalyst |
| 7 | rain_t+6 | 0.1013 | 2.2368 | Catalyst |
| 8 | rain_t+5 | 0.1004 | 2.0422 | Catalyst |
| 9 | rain_t+8 | 0.0979 | 2.0710 | Catalyst |
| 10 | rain_t+3 | 0.0977 | 1.7849 | Catalyst |
...
|--|--|--|--|
| Noise | 22 | 9.9% | low everywhere — candidate for pruning |
| Catalyst | 56 | 25.1% | strong AND interacting — load-bearing |
| Nonlinear Driver | 13 | 5.8% | strong with curved relationship |
| Volatile Specialist | 9 | 4.0% | strong but context-dependent |
| Stable Contributor | 42 | 18.8% | moderate, reliable |
| Complex Driver | 81 | 36.3% | complex behaviour across all four axes |
...
|--|--|--|
| INVESTIGATE (unstable) | 127 | archetype flipped — role uncertain |
| CONFIDENTLY KEEP | 53 | stable + important — load-bearing |
| MONITOR (borderline) | 38 | stability between 0.5 and 0.7 |
| KEEP (stable) | 5 | stable but moderate importance |

**Investigate** (127): `gwl_t-20`, `gwl_t-19`, `gwl_t-18`, `gwl_t-17`, `gwl_t-16`, `gwl_t-15`, `gwl_t-14`, `gwl_t-13`, `wl_t-24`, `wl_t-23`
...
- **k** = 5 groups
- **silhouette** = 0.236  _(higher = tighter clusters; >0.5 is strong, >0.2 is moderate)_
- **permutation p-value** = 0.000  _(<0.05 means clusters aren't random)_
- **bootstrap ARI** = 0.297  _(≥0.5 means clustering is stable)_
- **best NC fraction** = 20.0%  _(needs >50% to prune)_

| Group | Size | NC % | Mean Impact | Recommendation |
|--|--|--|--|--|
| 0 | 62 | 4.8% | 0.0387 | KEEP — mostly useful |
| 1 | 34 | 11.8% | 0.0021 | KEEP — mostly useful |
| 2 | 87 | 11.5% | 0.0044 | KEEP — mostly useful |
| 3 | 25 | 8.0% | 0.0031 | KEEP — mostly useful |
| 4 | 15 | 20.0% | 0.0018 | KEEP — mostly useful |
