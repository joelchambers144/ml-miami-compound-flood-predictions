...
_Generated 2026-05-12 13:27:41 — 30 checkpoint(s), 187 features._

## Diagnostics — model health overview

### ⚠ `trust_instability` · **warn** — 132/187 features are unstable across checkpoints

**What was observed.** More than half (71%) of features changed archetype between checkpoints (similarity-weighted stability < 0.5).
...
**What was observed.** Noise 14%, Catalyst 22%, Complex 29%.
...
**What was observed.** k=4 functional groups, silhouette=0.31, permutation p=0.000, bootstrap ARI=0.47, best group NC fraction=30%.  Abort triggered because: no group has >50% Noise Candidates (best=30%) ; bootstrap stability low (ARI=0.47<0.5).
...
**What was observed.** Final-checkpoint mean Volatility = 3.869e-06 ; median of earlier checkpoints = 3.769e-06 (ratio = 1.03×).
...
|-----|------|-----|-----|-----|
| impact | 0.0126 | 0.0334 | 0.0001 | 0.3008 |
| volatility | 0.0000 | 0.0000 | 0.0000 | 0.0002 |
| nonlinearity | 0.0057 | 0.0174 | 0.0003 | 0.1889 |
| interaction | 0.1309 | 0.1876 | 0.0149 | 1.4415 |
...
|--|--|--|--|--|
| 1 | gwl | 0.3008 | 1.4415 | Catalyst |
| 2 | gwl_t-1 | 0.2161 | 1.1099 | Catalyst |
| 3 | gwl_t-2 | 0.1539 | 0.7899 | Catalyst |
| 4 | gwl_t-3 | 0.1089 | 0.5426 | Catalyst |
| 5 | rain_t+1 | 0.0980 | 0.9536 | Catalyst |
| 6 | rain_t+2 | 0.0871 | 1.0617 | Catalyst |
| 7 | rain | 0.0838 | 0.5457 | Catalyst |
| 8 | gwl_t-4 | 0.0758 | 0.3786 | Catalyst |
| 9 | rain_t-1 | 0.0701 | 0.5364 | Catalyst |
| 10 | stgH | 0.0606 | 0.2745 | Catalyst |
...
|--|--|--|--|
| Noise | 26 | 13.9% | low everywhere — candidate for pruning |
| Hidden Interactor | 5 | 2.7% | weak alone, strong via interactions |
| Catalyst | 42 | 22.5% | strong AND interacting — load-bearing |
| Nonlinear Driver | 13 | 7.0% | strong with curved relationship |
| Volatile Specialist | 10 | 5.3% | strong but context-dependent |
| Stable Contributor | 36 | 19.3% | moderate, reliable |
| Complex Driver | 55 | 29.4% | complex behaviour across all four axes |
...
|--|--|--|
| INVESTIGATE (unstable) | 132 | archetype flipped — role uncertain |
| CONFIDENTLY KEEP | 28 | stable + important — load-bearing |
| MONITOR (borderline) | 25 | stability between 0.5 and 0.7 |
| KEEP (stable) | 2 | stable but moderate importance |

**Investigate** (132): `gwl_t-24`, `gwl_t-23`, `gwl_t-21`, `gwl_t-20`, `gwl_t-19`, `gwl_t-18`, `gwl_t-17`, `gwl_t-15`, `gwl_t-12`, `gwl_t-11`
...
- **k** = 4 groups
- **silhouette** = 0.312  _(higher = tighter clusters; >0.5 is strong, >0.2 is moderate)_
- **permutation p-value** = 0.000  _(<0.05 means clusters aren't random)_
- **bootstrap ARI** = 0.469  _(≥0.5 means clustering is stable)_
- **best NC fraction** = 30.3%  _(needs >50% to prune)_

| Group | Size | NC % | Mean Impact | Recommendation |
|--|--|--|--|--|
| 0 | 110 | 8.2% | 0.0186 | KEEP — mostly useful |
| 1 | 29 | 17.2% | 0.0056 | KEEP — mostly useful |
| 2 | 15 | 13.3% | 0.0044 | KEEP — mostly useful |
| 3 | 33 | 30.3% | 0.0027 | REVIEW — significant noise |
