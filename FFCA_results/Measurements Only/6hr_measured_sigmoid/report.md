...
_Generated 2026-05-12 13:27:15 — 30 checkpoint(s), 175 features._

## Diagnostics — model health overview

### ⚠ `trust_instability` · **warn** — 115/175 features are unstable across checkpoints

**What was observed.** More than half (66%) of features changed archetype between checkpoints (similarity-weighted stability < 0.5).
...
**What was observed.** Noise 13%, Catalyst 22%, Complex 31%.
...
**What was observed.** k=4 functional groups, silhouette=0.29, permutation p=0.000, bootstrap ARI=0.41, best group NC fraction=20%.  Abort triggered because: no group has >50% Noise Candidates (best=20%) ; bootstrap stability low (ARI=0.41<0.5).
...
**What was observed.** Final-checkpoint mean Volatility = 4.109e-06 ; median of earlier checkpoints = 3.202e-06 (ratio = 1.28×).
...
### ℹ `trust_keep_recommended` · **info** — 36 features are stably important across all checkpoints
...
|-----|------|-----|-----|-----|
| impact | 0.0117 | 0.0278 | 0.0003 | 0.2271 |
| volatility | 0.0000 | 0.0000 | 0.0000 | 0.0002 |
| nonlinearity | 0.0049 | 0.0103 | 0.0003 | 0.0810 |
| interaction | 0.1171 | 0.1297 | 0.0274 | 0.9232 |
...
|--|--|--|--|--|
| 1 | gwl | 0.2271 | 0.7230 | Catalyst |
| 2 | gwl_t-1 | 0.1718 | 0.5370 | Catalyst |
| 3 | gwl_t-2 | 0.1371 | 0.4991 | Catalyst |
| 4 | gwl_t-3 | 0.1159 | 0.4155 | Catalyst |
| 5 | gwl_t-4 | 0.0904 | 0.3465 | Catalyst |
| 6 | rain | 0.0837 | 0.9232 | Catalyst |
| 7 | gwl_t-5 | 0.0774 | 0.2991 | Catalyst |
| 8 | gwl_t-6 | 0.0632 | 0.2487 | Catalyst |
| 9 | gwl_t-7 | 0.0547 | 0.2456 | Catalyst |
| 10 | rain_t-3 | 0.0457 | 0.4743 | Catalyst |
...
|--|--|--|--|
| Noise | 22 | 12.6% | low everywhere — candidate for pruning |
| Hidden Interactor | 6 | 3.4% | weak alone, strong via interactions |
| Catalyst | 38 | 21.7% | strong AND interacting — load-bearing |
| Nonlinear Driver | 12 | 6.9% | strong with curved relationship |
| Volatile Specialist | 9 | 5.1% | strong but context-dependent |
| Stable Contributor | 33 | 18.9% | moderate, reliable |
| Complex Driver | 55 | 31.4% | complex behaviour across all four axes |
...
|--|--|--|
| INVESTIGATE (unstable) | 115 | archetype flipped — role uncertain |
| CONFIDENTLY KEEP | 35 | stable + important — load-bearing |
| MONITOR (borderline) | 24 | stability between 0.5 and 0.7 |
| KEEP (stable) | 1 | stable but moderate importance |

**Investigate** (115): `gwl_t-24`, `gwl_t-23`, `gwl_t-21`, `gwl_t-17`, `gwl_t-16`, `gwl_t-15`, `gwl_t-13`, `gwl_t-12`, `gwl_t-11`, `gwl_t-10`
...
- **k** = 4 groups
- **silhouette** = 0.294  _(higher = tighter clusters; >0.5 is strong, >0.2 is moderate)_
- **permutation p-value** = 0.000  _(<0.05 means clusters aren't random)_
- **bootstrap ARI** = 0.414  _(≥0.5 means clustering is stable)_
- **best NC fraction** = 20.0%  _(needs >50% to prune)_

| Group | Size | NC % | Mean Impact | Recommendation |
|--|--|--|--|--|
| 0 | 89 | 7.9% | 0.0171 | KEEP — mostly useful |
| 1 | 19 | 15.8% | 0.0087 | KEEP — mostly useful |
| 2 | 20 | 20.0% | 0.0034 | KEEP — mostly useful |
| 3 | 47 | 17.0% | 0.0062 | KEEP — mostly useful |
