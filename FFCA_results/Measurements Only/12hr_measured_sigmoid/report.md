...
_Generated 2026-05-12 13:27:16 — 30 checkpoint(s), 175 features._

## Diagnostics — model health overview

### ⚠ `trust_instability` · **warn** — 124/175 features are unstable across checkpoints
...
**What was observed.** Noise 12%, Catalyst 24%, Complex 32%.
...
**What was observed.** k=3 functional groups, silhouette=0.39, permutation p=0.000, bootstrap ARI=0.40, best group NC fraction=24%.  Abort triggered because: no group has >50% Noise Candidates (best=24%) ; bootstrap stability low (ARI=0.40<0.5).
...
**What was observed.** Final-checkpoint mean Volatility = 4.302e-06 ; median of earlier checkpoints = 3.613e-06 (ratio = 1.19×).
...
### ℹ `trust_keep_recommended` · **info** — 31 features are stably important across all checkpoints
...
|-----|------|-----|-----|-----|
| impact | 0.0115 | 0.0316 | 0.0001 | 0.2677 |
| volatility | 0.0000 | 0.0000 | 0.0000 | 0.0001 |
| nonlinearity | 0.0048 | 0.0179 | 0.0002 | 0.1918 |
| interaction | 0.0975 | 0.1526 | 0.0090 | 1.2180 |
...
|--|--|--|--|--|
| 1 | gwl | 0.2677 | 1.2180 | Catalyst |
| 2 | gwl_t-1 | 0.2079 | 0.9501 | Catalyst |
| 3 | gwl_t-2 | 0.1504 | 0.7074 | Catalyst |
| 4 | rain | 0.1295 | 0.6975 | Catalyst |
| 5 | gwl_t-3 | 0.1122 | 0.5297 | Catalyst |
| 6 | rain_t-1 | 0.0801 | 0.5088 | Catalyst |
| 7 | gwl_t-4 | 0.0758 | 0.3542 | Catalyst |
| 8 | rain_t-2 | 0.0528 | 0.3401 | Catalyst |
| 9 | rain_t-3 | 0.0491 | 0.2759 | Catalyst |
| 10 | gwl_t-5 | 0.0447 | 0.1957 | Catalyst |
...
|--|--|--|--|
| Noise | 21 | 12.0% | low everywhere — candidate for pruning |
| Hidden Interactor | 2 | 1.1% | weak alone, strong via interactions |
| Catalyst | 42 | 24.0% | strong AND interacting — load-bearing |
| Nonlinear Driver | 11 | 6.3% | strong with curved relationship |
| Volatile Specialist | 14 | 8.0% | strong but context-dependent |
| Stable Contributor | 29 | 16.6% | moderate, reliable |
| Complex Driver | 56 | 32.0% | complex behaviour across all four axes |
...
|--|--|--|
| INVESTIGATE (unstable) | 124 | archetype flipped — role uncertain |
| CONFIDENTLY KEEP | 30 | stable + important — load-bearing |
| MONITOR (borderline) | 20 | stability between 0.5 and 0.7 |
| KEEP (stable) | 1 | stable but moderate importance |

**Investigate** (124): `gwl_t-24`, `gwl_t-23`, `gwl_t-22`, `gwl_t-21`, `gwl_t-20`, `gwl_t-19`, `gwl_t-17`, `gwl_t-16`, `gwl_t-15`, `gwl_t-14`
...
- **k** = 3 groups
- **silhouette** = 0.388  _(higher = tighter clusters; >0.5 is strong, >0.2 is moderate)_
- **permutation p-value** = 0.000  _(<0.05 means clusters aren't random)_
- **bootstrap ARI** = 0.401  _(≥0.5 means clustering is stable)_
- **best NC fraction** = 23.5%  _(needs >50% to prune)_

| Group | Size | NC % | Mean Impact | Recommendation |
|--|--|--|--|--|
| 0 | 108 | 5.6% | 0.0138 | KEEP — mostly useful |
| 1 | 50 | 22.0% | 0.0073 | KEEP — mostly useful |
| 2 | 17 | 23.5% | 0.0095 | KEEP — mostly useful |
