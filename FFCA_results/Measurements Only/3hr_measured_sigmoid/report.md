...
_Generated 2026-05-12 13:27:13 — 30 checkpoint(s), 175 features._

## Diagnostics — model health overview

### ⚠ `trust_instability` · **warn** — 107/175 features are unstable across checkpoints

**What was observed.** More than half (61%) of features changed archetype between checkpoints (similarity-weighted stability < 0.5).
...
**What was observed.** Noise 16%, Catalyst 23%, Complex 30%.
...
**What was observed.** k=2 functional groups, silhouette=0.45, permutation p=0.000, bootstrap ARI=0.32, best group NC fraction=19%.  Abort triggered because: no group has >50% Noise Candidates (best=19%) ; bootstrap stability low (ARI=0.32<0.5).
...
**What was observed.** Final-checkpoint mean Volatility = 3.347e-06 ; median of earlier checkpoints = 2.419e-06 (ratio = 1.38×).
...
### ℹ `trust_keep_recommended` · **info** — 39 features are stably important across all checkpoints
...
### ℹ `trust_prune_recommended` · **info** — 2 features are confidently Noise across all checkpoints
...
|-----|------|-----|-----|-----|
| impact | 0.0120 | 0.0331 | 0.0001 | 0.3035 |
| volatility | 0.0000 | 0.0000 | 0.0000 | 0.0002 |
| nonlinearity | 0.0052 | 0.0162 | 0.0001 | 0.1698 |
| interaction | 0.1085 | 0.1705 | 0.0080 | 1.3639 |
...
|--|--|--|--|--|
| 1 | gwl | 0.3035 | 1.3639 | Catalyst |
| 2 | gwl_t-1 | 0.2107 | 0.9981 | Catalyst |
| 3 | gwl_t-2 | 0.1489 | 0.7176 | Catalyst |
| 4 | gwl_t-3 | 0.1072 | 0.5297 | Catalyst |
| 5 | rain | 0.0894 | 0.6969 | Catalyst |
| 6 | gwl_t-4 | 0.0782 | 0.3610 | Catalyst |
| 7 | stgH | 0.0606 | 0.3090 | Catalyst |
| 8 | rain_t-1 | 0.0589 | 0.8144 | Catalyst |
| 9 | rain_t-2 | 0.0554 | 0.5178 | Catalyst |
| 10 | gwl_t-5 | 0.0524 | 0.2655 | Catalyst |
...
|--|--|--|--|
| Noise | 28 | 16.0% | low everywhere — candidate for pruning |
| Hidden Interactor | 4 | 2.3% | weak alone, strong via interactions |
| Catalyst | 40 | 22.9% | strong AND interacting — load-bearing |
| Nonlinear Driver | 10 | 5.7% | strong with curved relationship |
| Volatile Specialist | 9 | 5.1% | strong but context-dependent |
| Stable Contributor | 32 | 18.3% | moderate, reliable |
| Complex Driver | 52 | 29.7% | complex behaviour across all four axes |
...
|--|--|--|
| INVESTIGATE (unstable) | 107 | archetype flipped — role uncertain |
| CONFIDENTLY KEEP | 33 | stable + important — load-bearing |
| MONITOR (borderline) | 27 | stability between 0.5 and 0.7 |
| KEEP (stable) | 6 | stable but moderate importance |
| CONFIDENTLY PRUNE | 2 | stable + always Noise — safe to remove |

**Prunable features** (2): `gate2_t-13`, `gate2_t-7`

**Investigate** (107): `gwl_t-24`, `gwl_t-23`, `gwl_t-21`, `gwl_t-20`, `gwl_t-19`, `gwl_t-18`, `gwl_t-12`, `wl_t-24`, `wl_t-23`, `wl_t-21`
...
- **k** = 2 groups
- **silhouette** = 0.453  _(higher = tighter clusters; >0.5 is strong, >0.2 is moderate)_
- **permutation p-value** = 0.000  _(<0.05 means clusters aren't random)_
- **bootstrap ARI** = 0.321  _(≥0.5 means clustering is stable)_
- **best NC fraction** = 18.7%  _(needs >50% to prune)_

| Group | Size | NC % | Mean Impact | Recommendation |
|--|--|--|--|--|
| 0 | 134 | 18.7% | 0.0138 | KEEP — mostly useful |
| 1 | 41 | 7.3% | 0.006 | KEEP — mostly useful |
